...
defaultMeta =
  ...
  <> supTableTitle (str "Table" <> space <> str "S")
  ...
  <> supTblPrefix ([str "tbl." <> space <> str "S", str "tbls." <> space <> str "S"])
  ...
  <> supTableTemplate (var "supTableTitle" <> var "i" <> var "titleDelim" <> space <> var "t")
